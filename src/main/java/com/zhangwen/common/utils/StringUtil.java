...
public class StringUtil {
	...
	public static String randomChineseString(){
		...
		int end;
		Random r = new Random();
		begin = (176+Math.abs(r.nextInt(39)));
		end = (176+Math.abs(r.nextInt(93)));
		
		byte[] b = new byte[2];
		b[0] = Integer.valueOf(begin).byteValue();
	 ...
	 * @Description: 返回中文姓名，必须以真实姓开头，百家姓在“六、附百家姓”里，名使用1-2个随机汉字(8分)，内部调用randomChineseString()方法
	 * @return
	 * @return: String
	 */
	public static String generateChineseName(){
		...
		String name1 = str[RandomUtil.random(1, str.length-1)];
